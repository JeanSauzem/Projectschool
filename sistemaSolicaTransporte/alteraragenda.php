...
<html lang="pt-br">
    ...
    <body>
        <div class="container">
            ...
            <h3>Painel Administrativo - Alteração da Agenda</h3>
            <div id="contactform"> 
               ...
               <a href="painel1.php"><input type="button" value="Pagina Inicial" name="home"  class="button" /></a>
                ...
                <form  class="rounded" action="alteraragenda.php" method="post"  >
...
if (isset($_POST["datapartida"]) && isset($_POST["horasaida"]) && isset($_POST["datafinal"]) && isset($_POST["cod"]) &&isset($_POST["horachegada"]) && isset($_POST["veiculo"]) && isset($_POST["destino"]) && isset($_POST["descricao"])) {
   ...
   $id=$_POST["cod"];
   header('location: http://localhost/sistemaSolicaTransporte/painel1.php');
}
